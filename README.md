...
An end-to-end Machine Learning regression project to predict house prices using the Ames Housing dataset.

##  Project Overview
* **Goal:** Predict residential property prices based on features like area, year built, overall quality, and location.
* **Kaggle Score (RMSLE):** `0.26350`
* **Leaderboard Rank:** `2975`
